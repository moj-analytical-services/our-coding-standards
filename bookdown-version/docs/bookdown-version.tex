...
\hypertarget{manage-project-dependencies}{%
\subsection{Manage project dependencies}\label{manage-project-dependencies}}
...
\begin{verbatim}
## [971692] (Local) (HEAD) nikki-restructure
\end{verbatim}
...
\section{Collaboration}\label{collaborate}}
...
\subsubsection*{Share the knowledge}\label{share-the-knowledge}}
\addcontentsline{toc}{subsubsection}{Share the knowledge}
...
\section{Accuracy}\label{accurate}}
...
\section{Understandability}\label{understand}}
...
\hypertarget{separate-functions-out}{%
\subsection{Separate functions out}\label{separate-functions-out}}

\hypertarget{coding-style}{%
\subsection{Coding style}\label{coding-style}}

\hypertarget{apply-a-linter}{%
\subsubsection*{Apply a linter}\label{apply-a-linter}}
\addcontentsline{toc}{subsubsection}{Apply a linter}

\hypertarget{names-have-power-and-purpose---use-them-wisely}{%
\subsubsection*{Names have power and purpose - use them wisely}\label{names-have-power-and-purpose---use-them-wisely}}
\addcontentsline{toc}{subsubsection}{Names have power and purpose - use them wisely}
...
\subsubsection*{Code should be correct, clear, concise - in that order}\label{code-should-be-correct-clear-concise---in-that-order}}
\addcontentsline{toc}{subsubsection}{Code should be correct, clear, concise - in that order}
...
\subsubsection*{Everything fails at some point}\label{everything-fails-at-some-point}}
\addcontentsline{toc}{subsubsection}{Everything fails at some point}
...
\subsubsection*{Other team members are users too - treat them with respect}\label{other-team-members-are-users-too---treat-them-with-respect}}
\addcontentsline{toc}{subsubsection}{Other team members are users too - treat them with respect}
