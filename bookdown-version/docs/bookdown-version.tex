...
\addcontentsline{toc}{section}{Guidance structure}
...
\addcontentsline{toc}{subsection}{Coding Style}
...
\addcontentsline{toc}{subsection}{Testing in R}
...
\addcontentsline{toc}{subsection}{Testing in Python}
...
\addcontentsline{toc}{subsection}{Testing in Javascript}
...
\addcontentsline{toc}{subsection}{Github-Flow is a working practice that helps to:}
...
\addcontentsline{toc}{subsection}{There are 6 steps to our process:}
...
\addcontentsline{toc}{subsection}{Useful links for using github}
