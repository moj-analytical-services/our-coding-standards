...
Part of this is [managing dependencies](#projdep) so projects can be run on another machine. Another key part is the use of Github for enabling code sharing. Checking the code into Github is a key part of the version control workflow.
...
When you create your git project using `git init`, immediately branch off to a development branch e.g. using `git checkout -b dev`, and work on this branch.  
...
We have tweaked it a little from what is [described on GitHub][4] 
...
For some further reading we strongly suggest reading this [article][5] that explains these git commands and others in a bit more detail.
...
#### Useful links for using github {-#gitlink}
